...
//            String query = "select first_name from actor where first_name='Nick'";
//            String query = "select store_id from store where store_id+manager_staff_id>2";
//            String query = "select store_id from store";
//            String query = "select first_name,actor_id from actor where (actor_id+1)*2>100 and actor_id<100";
//            String query = "select first_name,actor_id from actor where (actor_id+1)*2>100 and first_name='Nick'";
//            String query = "select first_name,actor_id from actor where first_name='Nick' and actor_id=2 or actor_id=44";
            String query = "select customer_id,store_id,customer_id+store_id from customer";
...
//            String query = "select actor.actor_id,film_actor.film_id from actor join film_actor on actor.actor_id = film_actor.actor_id";
...
//            System.out.println(result.get(0)[0].getClass());
...
//                    if(!expected.get(key).get(i).equals(actual.get(key).get(i))){
//                        System.out.println("Expected "+expected.get(key).get(i));
//                        System.out.println("Got "+actual.get(key).get(i));
//                    }else{
//                        System.out.println("Passed "+actual.get(key).get(i));
//                    }
    ...
    @Test
    public void testJoinAggregateSort_2() {
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "select film_id, count(film_id) as cnt\n"
                    + "from inventory i\n"
...
////                        System.out.println("Passed "+actual.get(key).get(i));
////                    }
//                    System.out.println(actual.get(key).get(i));
//
//                }
//            }
